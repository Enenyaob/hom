										...
										<div class="row">
											<div class="col-md-6">
												...
												<ul class="list-icons">
													...
													<li><a href="tel:#"><i class="fa fa-phone pr-10 text-default"></i>(+234) 700-000-0000</a></li>
													<?php if(isset($_SESSION['role'])) : ?>
														<li><a href="<?php echo lcfirst($_SESSION['role']); ?>"><i class="fa fa-user pr-10"></i>Dashboard</a></li>
													<?php else: ?>	
