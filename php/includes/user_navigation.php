...
$current_page = str_replace('.php', '', $current_page);  // trim off the extension
 ...
 if ($_SESSION['role'] == 'Counselor'){
 	...
 	if ($_SESSION['role'] == 'Admin') {
 		$item = ['admin' => 'Dash Board', 'signup' => 'Register worker', 'view_workers' => 'View Workers', 'add_member' => 'Create New Member', 'verify_payments' =>'Verify Payments', 'search_member' =>'Find Member', 'edit_user' =>'Edit Users', 'calender' => 'Calender']; 	
}
