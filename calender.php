  ...
  <section class="cd-h-timeline js-cd-h-timeline margin-bottom-md">
   ...
   <div class="main">
    ...
    if($_SESSION['role'] == 'Pastorate'){
      echo'<span class="btn btn-default btn-animated" id="sl-icon">
                                <span data-toggle="modal" data-target="#myModal" id="cursor">Add</span>
                  <i class="pl-5  fa fa-calendar"></i></span>';
                };
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> " method="post" role="form" id="calendar">
