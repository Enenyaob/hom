				 ...
				 <?php include("php/includes/layouts/portal_nav.php"); ?>
						...
						<div class="col-md-4 ">
							<div class="pv-30 ph-20 feature-box bordered shadow text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
								...
								<a href="signup">Go Here <i class="pl-5 fa fa-angle-double-right"></i></a>
							</div>
						</div>
                        <div class="col-md-4 ">
							<div class="pv-30 ph-20 feature-box bordered shadow text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
						...
						<div class="col-md-4 ">
							<div class="pv-30 ph-20 feature-box bordered shadow text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="150">
								...
								<h3>Create First Timer</h3>
								<div class="separator clearfix"></div>
								
								<a href="first_timer">Go Here <i class="pl-5 fa fa-angle-double-right"></i></a>
							</div>
						</div>
                        ...
                        <div class="col-md-4 ">
							<div class="pv-30 ph-20 feature-box bordered shadow text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="150">
								...
								<a href="verify_payments">Go Here <i class="pl-5 fa fa-angle-double-right"></i></a>
							</div>
						</div>
