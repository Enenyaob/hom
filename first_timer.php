 ...
 $connection = require_once ('php/db_oop.php');
   $home = lcfirst($_SESSION['role']);
	...
	if($_SERVER['REQUEST_METHOD'] ==='POST'){
		...
		$errors = validateSelect($age_group, $errors);
...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<title>RCCG Hom Ejigbo | Create Member</title>
	...
	<body id="appoints" class="no-trans  transparent-header  ">
		...
		<?php  include('php/includes/layouts/header_admin.php'); ?>
			...
			<section class="pv-30 light-gray-bg clearfix">
					<div class="container">
                    <h3 class="title text-center  text-default"><b>First Timer</b></h3>
            ...
            <div class="main">
							<div class="form-block center-block p-30 light-gray-bg border-clear">
                             ...
                             <?php
				                ...
				                ?>
								<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> " id="form-data" method="post" class="form-horizontal">
								...
								<div class="form-group has-feedback">
									...
									<div class="form-group has-feedback">
										<label for="other_name" class="col-sm-3 control-label">Other Name</label>
										<div class="col-sm-8">
									  ...
									  <div class="form-group has-feedback">
										...
										<div class="col-sm-8">
											<select name="age_group" id="selc" class="form-control">
												<?php if (isset($age_group)) :?>

																	<option value="<?php echo $age_group; ?>"><?php echo $age_group; ?></option>
												<?php else : ?>
							                    <option value="Please select group">Choose age group</option>
							          <?php endif; ?>
